...
<body>
    ...
    $katayangdicari = "sexy!";
    $posisi = strpos($string3, $katayangdicari);
    $kalimatawal = substr($string3, 0, $posisi - 1);
    $katapengganti = "awesome!";
    $kalimatakhir = $kalimatawal . " " . $katapengganti;

    echo "<br>" . $kalimatakhir . "<br>";
